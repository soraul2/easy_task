...
이 문서는 기존 [`TASK_REMINDER_PLAN.md`](TASK_REMINDER_PLAN.md)의 완료 처리 정책을 보완한 후속 설계와 구현 기록이다. 아래 정책은 공통 코어, iPhone, macOS 완료 경로에 반영되었고 검증 항목은 마지막 구현 상태에 기록한다.
...
3. `mobile/App/MobileTaskDetailSheet.swift`
...
4. `mobile/App/TaskNotificationScheduler.swift`
...
- `shared/Core/Services/TaskReminderRules.swift`
- `mobile/App/TaskNotificationScheduler.swift`
...
- `mobile/App/MobileBoardView.swift`
- 필요 시 `mobile/App/MobileBoardComponents.swift`
...
- `mobile/App/MobileTaskDetailSheet.swift`
...
- `mobile/App/MobileCarryoverSheet.swift`
...
- `desktop/App/Views/BoardView.swift`
- `desktop/App/Views/DesktopTaskDetailSheet.swift`
- `desktop/App/Views/DesktopKanbanComponents.swift`
...
- `mobile/App/MobileBoardComponents.swift`
- `mobile/App/MobileTaskDetailSheet.swift`
- `desktop/App/Views/DesktopKanbanComponents.swift`
- `desktop/App/Views/DesktopTaskDetailSheet.swift`
