...
- iOS/macOS 공유 scheme과 최소 launch smoke test 타겟을 커밋한다.
...
git diff --check
swift test
swift build --product TodoDesktopMVP
xcodebuild -project EasyTask.xcodeproj -scheme EasyTask -configuration Debug -sdk iphonesimulator CODE_SIGNING_ALLOWED=NO build
```
